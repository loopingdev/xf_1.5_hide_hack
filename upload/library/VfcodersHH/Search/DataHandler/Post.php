...
class VfcodersHH_Search_DataHandler_Post extends XFCP_VfcodersHH_Search_DataHandler_Post
{
      ...
      public function prepareResult(array $result, array $viewingUser)
	  {
	         if (isset($result['permissions']) AND count($result['permissions']))
			 {
				  ...
				  $result['message'] = $this->_parser->parse_hidetags($result['message'], $result['node_id'], 
				   $result['thread_id'], $result['user_id'], $result['post_id'], $result['like_users']);
